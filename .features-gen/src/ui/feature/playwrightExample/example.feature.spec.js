...
test.describe('Example feature', () => {
  ...
  test('Open Playwright website', async ({ Given, page, Then, When, And }) => { 
    ...
    await And('I click on the "Ambassadors" link', null, { page }); 
