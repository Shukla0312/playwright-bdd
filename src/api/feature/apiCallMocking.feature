...
Feature: Mock API Call for Product Details
  ...
  Scenario: Verify the product details after mocking the API response
    ...
    When I should mock the response for the product details and change the price to 100
    And I click on View "Zara Coat 3"
    Then I should see the updated product details with the new price